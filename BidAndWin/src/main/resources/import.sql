...
insert into item(name, description, buy_it_price, category_id, start_price, user_id, end_time, bid_increment) values ('a', 'nagyon jo kis leiras', 2500, 1, 1000, 1, timestamp '2017-10-12 21:22:23', 100);
